      ...
      <header>
        ...
        <div className="info">
          ...
          <div className="row">
            ...
            <h6>{askPrice !== '-' ? Number(askPrice).toFixed(2) : '--'}</h6>
          </div>
          <div className="row">
            <h5>Preço de compra: </h5>
            <h6>{bidPrice !== '-' ? Number(bidPrice).toFixed(2) : '--'}</h6>
          </div>
        </div>
      </header>
    </article>
